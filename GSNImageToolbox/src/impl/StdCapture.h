...
int StdCapture::StdCapture::secure_dup(int src)
{
    int ret = -1;
    bool fd_blocked = false;
    do
...
void StdCapture::StdCapture::secure_pipe(int *pipes)
{
    int ret = -1;
    bool fd_blocked = false;
    do
...
void StdCapture::StdCapture::secure_dup2(int src, int dest)
{
    int ret = -1;
    bool fd_blocked = false;
    do
...
void StdCapture::StdCapture::secure_close(int &fd)
{
    int ret = -1;
    bool fd_blocked = false;
    do
